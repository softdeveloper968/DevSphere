...
public class VendorRequestCodesViewModel : BaseListViewModel
{
    ...
    public bool AllowLengthChange = false;
    ...
    public bool AddIncludeClearOption = true;
    ...
    public VendorRequestCodesViewModel(VendorViewType vt)
    {
        this.ViewType = vt;
        InitPageLength();
    }
    private void InitFollowUpCodes()
    {
    }
}
