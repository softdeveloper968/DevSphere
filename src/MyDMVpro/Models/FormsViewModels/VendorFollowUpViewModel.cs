...
{
    public class VendorFollowUpViewModel : BaseListViewModel
    {
        public Guid? RequestId;
        public VendorViewType ViewType;

        public bool EnablePDF;
        public bool AllowLengthChange;
        ...
        public bool AllowComplete = true;
        ...
        public VendorFollowUpViewModel(VendorViewType vt, string pageName)
        {
            PageName = pageName;
            this.ViewType = vt;
            InitPageLength();
